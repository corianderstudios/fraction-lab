...
import { isTracked } from "../data/sections.js";
...
/** Terms grouped by topic, in the order a ()irst-time learner meets them. */
    ...
    terms: [
      {
        term: "Fraction",
        definition:
          "A number that describes part of a whole, written as one number over another.",
      ...
      },
      {
        term: "Fraction bar",
        definition:
          'The line between the numerator and denominator. It also means "divided by".',
        example: "3/4 is the same as 3 ÷ 4.",
      },
      {
        term: "Whole",
        definition:
          "One complete thing or group before it is split into parts.",
      ...
      },
      {
        term: "Equal parts",
        definition:
          "Pieces that are all exactly the same size. A fraction only works when the parts are equal.",
  ...
  },
  {
    ...
    terms: [
      ...
      },
      {
        ...
        definition:
          "A fraction whose numerator is smaller than its denominator, so it is less than one whole.",
      ...
      },
      {
        ...
        definition:
          "A fraction whose numerator is equal to or bigger than its denominator, so it is one whole or more.",
      ...
      },
      {
        term: "Whole number",
        definition:
          "A counting number with no fraction part, such as 0, 1, 2 or 3. Any whole number can be written over 1.",
  ...
  },
  {
    ...
    terms: [
      ...
      },
      {
        term: "Simplify",
        definition:
          "To rewrite a fraction with smaller numbers by dividing the top and bottom by the same number.",
        example: "6/8 simplifies to 3/4 by dividing both by 2.",
      },
      {
        term: "Simplest form",
        definition:
          "A fraction whose numerator and denominator share no factor except 1. Also called lowest terms.",
      ...
      },
      {
        term: "Reciprocal",
        definition:
          "A fraction flipped upside down. A number times its reciprocal always equals 1.",
    ...
    terms: [
      {
        term: "Factor",
        definition:
          "A whole number that divides into another number with nothing left over.",
      ...
      },
      {
        ...
        definition:
          "The largest factor two numbers share. Dividing by it simplifies a fraction in one step.",
      ...
      },
      {
        ...
        definition:
          "A denominator that two fractions share, or that both can be rewritten to have.",
        example: "1/3 and 1/4 can both be written in twelfths.",
      },
      {
        term: "Least common denominator (LCD)",
        definition:
          "The smallest common denominator. It is the LCM of the denominators.",
  ...
  },
  {
    ...
    terms: [
      ...
      },
      {
        ...
        example:
          "In 3/4 × 2/9, divide 3 and 9 by 3, and 2 and 4 by 2, to get 1/2 × 1/3.",
      },
      {
        term: "Keep, Change, Flip",
        definition:
          "A memory rule for dividing fractions: keep the first fraction, change ÷ to ×, flip the second fraction.",
        example: "2/3 ÷ 4/5 becomes 2/3 × 5/4.",
      },
      {
        term: "Bar model",
        definition:
          "A drawing of a bar split into equal parts, with some parts shaded to show a fraction.",
...
const TOTAL_TERMS = GLOSSARY.reduce(
...
export default function GlossaryPage() {
  ...
  const registered = isTracked("glossary");
      ...
      <div className="mx-auto w-full max-w-3xl flex-1 px-4 pb-10 sm:px-6">
        ...
        >
          ...
          <p id={hintId} role="status" className="mt-2 text-sm text-muted">
            {shown === TOTAL_TERMS
              ? `${TOTAL_TERMS} terms`
              : `Showing ${shown} of ${TOTAL_TERMS} terms`}
          </p>
        </form>
        ...
        {shown === 0 && (
          <div className="mt-6 panel p-5">
            ...
            <p className="mt-1 text-muted">
              Try a shorter word, or clear the search to see every term.
            </p>
            <button
              type="button"
            ...
            >
              ...
              <dl className="mt-3 divide-y divide-line rounded-2xl border border-line bg-surface">
                {group.terms.map((t) => (
                  <div
                    key={t.term}
                    className="grid grid-cols-[minmax(0,1fr)_auto] gap-x-4 p-4 sm:p-5"
                  >
                    <dt className="col-start-1 font-serif text-lg font-semibold">
                      {t.term}
                    </dt>
